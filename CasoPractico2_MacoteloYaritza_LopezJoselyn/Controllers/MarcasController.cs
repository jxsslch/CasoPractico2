...
namespace CasoPractico2_MacoteloYaritza_LopezJoselyn.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(TechstoreSaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("NombreMarca")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("NombreMarca")] Marca marca)
        {
        ...
        {
            return _context.Marcas.Any(e => e.NombreMarca == id);
        }
    }
}
